...
class ReportreturnSalesTable extends StatefulWidget {
  List data;
  ReportreturnSalesTable({Key? key, required this.data});

  @override
  State<ReportreturnSalesTable> createState() => _ReportreturnSalesTableState();
}

class _ReportreturnSalesTableState extends State<ReportreturnSalesTable> {

  @override
  void initState() {
    super.initState();
      Provider.of<ReportreturnSalesModel>(context, listen: false)
          .selectedRows = List.generate(widget.data.length, (index) => false);
    // Initialize the selectedRows list with false values for each row
    Provider.of<ReportreturnSalesModel>(context, listen: false).loadMoreData();

    Provider.of<ReportreturnSalesModel>(context, listen: false).dataPagesNubmer();
