...
import 'package:dashboard/widgets/CustomerAccountTableinfo.dart';

import 'package:dashboard/widgets/customerAccountTable.dart';
...
class _CustomerAccountState extends State<CustomerAccount> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CustomerAccountScreenModel>(
