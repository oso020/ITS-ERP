...
import 'package:dashboard/widgets/SupplierTransactionsTable.dart';

import 'package:flutter/material.dart';
import 'package:page_transition/page_transition.dart';
import 'package:provider/provider.dart';

class SupplierTransactions extends StatefulWidget {
  const SupplierTransactions({super.key});

  @override
  State<SupplierTransactions> createState() => _SupplierTransactionsState();
}

class _SupplierTransactionsState extends State<SupplierTransactions> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SupplierTransactionsScreenModel>(
