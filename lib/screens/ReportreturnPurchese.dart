...
import 'package:dashboard/widgets/returnpurcheseTables/tablereturnpurchese.dart';
...
class ReportreturnPurchese extends StatefulWidget {
  @override
  State<ReportreturnPurchese> createState() => _ReportreturnPurcheseState();
}

class _ReportreturnPurcheseState extends State<ReportreturnPurchese> {
                ...
                model.isClicked
                    ...
                    : SizedBox(
                        ...
                        child: model.data.isEmpty
                            ...
                            : ListView(
                                children: [
                                  ReportreturnPurcheseTable(data: model.data),
                                ],
                              ),
                      )
              ],
